            ...
            <main className="w-full max-w-7xl mx-auto px-6 py-4">
                <div className="w-full max-w-xl mx-auto bg-white p-4 md:p-6 rounded-xl shadow-xl transform transition-all">
                    ...
                    <div className="text-center mb-4">
                        ...
                        <h1 className="text-3xl font-bold text-gray-800 mb-2">Payment Authorized Successfully</h1>
                        <p className="text-gray-500">Order confirmed. We're preparing your brew!</p>
                    </div>
